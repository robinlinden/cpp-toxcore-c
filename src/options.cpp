...
bool tox_options::get_ipv6_enabled() const {
...
bool tox_options::get_udp_enabled() const {
...
bool tox_options::get_local_discovery_enabled() const {
...
TOX_PROXY_TYPE tox_options::get_proxy_type() const {
...
const char *tox_options::get_proxy_host() const {
...
uint16_t tox_options::get_proxy_port() const {
...
uint16_t tox_options::get_start_port() const {
...
uint16_t tox_options::get_end_port() const {
...
uint16_t tox_options::get_tcp_port() const {
...
bool tox_options::get_hole_punching_enabled() const {
...
TOX_SAVEDATA_TYPE tox_options::get_savedata_type() const {
...
const uint8_t *tox_options::get_savedata_data() const {
...
size_t tox_options::get_savedata_length() const {
...
tox_log_cb *tox_options::get_log_callback() const {
...
void *tox_options::get_log_user_data() const {
